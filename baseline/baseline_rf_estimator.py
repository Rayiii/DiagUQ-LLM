...
from common.calibration_metrics import (
    calculate_Brier,
    calculate_ece,
    calculate_nll,
    calculate_nll_ece,
)
from baseline.feature_selection import (
    correlation_select_k_features,
    lasso_select_k_features,
    mutual_info_select_k_features,
)
from common.platt_scaling import PlatScaling
from common.temperature_scaling import ModelWithTemperature
from features.load_feature_tensors import load_MMLU_X_Y, load_X_Y
...
# ---------------------------------------------------------------------------
# Baseline-style aliases (the legacy `supervised_calibration.*` names are
# preserved above for backward compatibility; the names below are the
# pipeline-neutral aliases used throughout the cleaned-up codebase).
# ---------------------------------------------------------------------------

train_baseline_estimator = train_supervised_calibration
train_baseline_estimator_mmlu = train_supervised_calibration_mmlu
evaluate_baseline_estimator = test_calibration
evaluate_baseline_estimator_mmlu = test_calibration_mmlu
